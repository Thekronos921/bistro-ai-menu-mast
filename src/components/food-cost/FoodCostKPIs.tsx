  ...
  const kpiData = [
    {
      ...
      icon: TrendingDown,
      trend: (avgFoodCostPercentage < 30 ? "up" : avgFoodCostPercentage > settings.criticalThreshold ? "down" : "neutral") as "up" | "down" | "neutral"
    },
    {
    ...
    },
    {
      ...
      icon: AlertTriangle,
      trend: (criticalDishes === 0 ? "up" : "down") as "up" | "down"
    },
    {
